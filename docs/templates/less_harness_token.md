...
- Triggers: some models ignore a tool until told when to use it. A literal trigger works: "After substantive edits, use the <lint tool> to check the files edited in the current change for linter errors. If you've introduced any, fix them if you can easily figure out how."
